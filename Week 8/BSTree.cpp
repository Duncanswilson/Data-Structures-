...
/*
The binary search tree function retHelper recursively loops through the tree until it has correctly gone to the pointer 
* matching the paramterized data until it finds the equal data or it as gone too far. 
* Sets searchData equal to the value aand then returns a true if found false otherwise 
